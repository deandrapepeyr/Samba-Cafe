...
export function MainLayout({ children, onLogoutClick, title }: MainLayoutProps) {
    ...
    <div className="flex h-screen bg-background overflow-hidden text-foreground">
      ...
      {isMobileSidebarOpen && (
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <div className="relative z-50 flex flex-col bg-background w-3/4 max-w-sm h-full shadow-2xl animate-in slide-in-from-left-full duration-300">
            <button 
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden flex items-center gap-4 px-4 h-16 border-b border-border bg-card shrink-0">
          <button 
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-card border-t border-border flex items-center justify-around h-16 z-40 pb-safe">
